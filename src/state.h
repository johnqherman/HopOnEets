...
static constexpr float GHOST_LAG_SMOOTH = 0.25f;    // EMA factor for the predicted lag (lower = smoother/slower)
...
static float g_lagSmooth = 0;                   // EMA of the predict lag in ticks (smooths network arrival jitter)
